...
const DressScreen = ({ navigation }) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.e}>
        <View style={styles.f}>
          <Text style={styles.title}>မင်္ဂလာဝတ်စုံအမျိုးအစား</Text>
        </View>
      </View>
      ...
      <View style={styles.e}>
        <View style={styles.f}>
          <Text style={styles.title}>သတို့သားမင်္ဂလာဝတ်စုံ</Text>
        </View>
      </View>
      ...
      <View style={styles.e}>
        <View style={styles.f}>
          <Text style={styles.title}>သဲတုန်မင်္ဂလာဝတ်စုံ</Text>
        </View>
      </View>
      ...
      <View style={styles.e}>
        <View style={styles.f}>
          <Text style={styles.title}>သတို့သမီးမင်္ဂလာဝတ်စုံ</Text>
        </View>
      </View>
      ...
      <View style={styles.e}>
        <View style={styles.f}>
          <Text style={styles.title}>
            မင်္ဂလာဝတ်စုံအတွက် ခန့်မှန်းအသုံးစရိတ်
          </Text>
        </View>
      </View>
